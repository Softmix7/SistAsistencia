...
$table->addRow();
$table->addCell(null, $cellRowContinue);
$table->addCell(2000,array('bgColor' => 'FFFFCC'), $cellVCentered)->addText('DATOS I ', null,$cellHCentered);
$table->addCell(6000)->addText($tipo_peo, null,$cellHCentered);
$table->addCell(2000,array('bgColor' => 'FFFFCC'), $cellVCentered)->addText('DATOS II', null, $cellHCentered);
$table->addCell(6000)->addText($tipo_peo, null,$cellHCentered);
...
$table->setWidth ( 100 * 50 );
            ...
            $table->addRow();
            $table->addCell(null, $cellColor2)->addText('DATOS PERSONAL',array('color' => 'FFFFFF'),$cellHCentered);
			...
			$table->addRow();
			$table->addCell(NULL,array('vMerge' => 'restart','borderBottomColor' => 'FFFFFF', 'bgColor' => '006B3D'))->addText("ID",array('color' => 'FFFFFF'),$cellHCentered);
            ...
            $table->addCell(NULL,array('vMerge' => 'restart','bgColor' => 'FF8400'))->addText("T",array('color' => 'FFFFFF'),$cellHCentered);
            ...
            $table->addCell(NULL,array('vMerge' => 'continue','bgColor' => 'FF0000'),$cellHCentered);
            ...
            $table->addCell(NULL,array('vMerge' => 'continue','bgColor' => '0000FF'),$cellHCentered);
			 ...
			 while ($regss=$rspta->fetch_object()) {
                ...
                $table->addCell(4000)->addText($regss->lastname_peo." ".$regss->name_peo."", array('color' => '000000'),$dafault);
                        ...
                        for($i=0;$i<$range;$i++):
                            ...
                            $rspta_assistance=$obj->listarassistance($regss->idpeople,$date_at,$tipo_peo);
                            ...
                            $newdate= date("Y-m-d",strtotime($date_star)+($i*(24*60*60)));
                                ...
                                $v = "";
                                    ...
                                    if($v=="A"){
                                                ...
                                                $table->addCell()->addText($v,array('color' => 'F2770A'),$cellHCentered);
                                    }elseif($v=="J"){
                                        ...
                                        if ($newdia=="S") {
                                            ...
                                            if($v=="C"){
                                                      $table->addCell(null,array('bgColor' => '#C65911'))->addText($v,array('color' => 'FFFFFF'),$cellHCentered);
                                            } else{
                                    ...
                                    if ($timein==null) {
                                        ...
                                        $table->addCell()->addText($status_tar,array('color' => '000000'),$cellHCentered);
                                        }
                                    }
...
$table->addCell(null, $cellRowContinue);
$table->addCell(2000,array('bgColor' => 'FFFFCC'), $cellVCentered)->addText('DATOS I ', null,$cellHCentered);
$table->addCell(6000)->addText($datos1_peo, null,$cellHCentered);
$table->addCell(2000,array('bgColor' => 'FFFFCC'), $cellVCentered)->addText('DATOS II', null, $cellHCentered);
$table->addCell(6000)->addText($datos2_peo, null,$cellHCentered);
...
$table->addRow();
        $table->addCell(null, $Color2)->addText('T',array('color' => 'FFFFFF'),$HCentered);
        $table->addCell(null, $Color4)->addText('Tardanza',array('color' => '000000'),$Centered);
$table->addRow();
