...
if ($tipo_peo=="Estudiante") {
    $spta_personal = $DBobj->listarstudent($tipo_peo,$datos1_peo,$datos2_peo,$anio_peoget);

    while ($row_personal=$spta_personal->fetch_object()) {
          $idpeople=$row_personal->idpeople;
...
$pdf.=' <tr>
        ...
        <td style="color:#000000; background-color:#FEFFE3;" >'.$newdia.'</td>';
...
<table style="width:80%; font-size: 8pt;padding: 2px;">
  ...
  $spta_personal = $DBobj->listarpersonal($tipo_peo,$anio_peoget);
