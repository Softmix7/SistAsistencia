...
$spreadsheet->getActiveSheet()->duplicateStyle($sharedStyle1, 'A6:H6');
...
$spreadsheet->getActiveSheet()->duplicateStyle($sharedStyle2, 'B1:H2');
$spreadsheet->getActiveSheet()->duplicateStyle($sharedStyle4, 'B3:H3');
...
$spreadsheet->getActiveSheet()->setCellValue('B2', "LISTADO DE ASISTENCIAS");
    ...
    if ($tipo_peo=="Estudiante") {
        if ($ident=="") {
            ...
            $spreadsheet->getActiveSheet()->setCellValue('B3', "DATOS1 : ". $datos1_peo);
            $spreadsheet->getActiveSheet()->setCellValue('E3', "DATOS2 : ". $datos2_peo);
      ...
      $spreadsheet->getActiveSheet()->setCellValue('E3', "DATOS2 : ". $datos2_peo);
        ...
        $spreadsheet->getActiveSheet()->setCellValue('B3', "DATOS1 : ". $tipo_peo);
        $spreadsheet->getActiveSheet()->setCellValue('E3', "DATOS2 : ". $tipo_peo);
        } else {
           $rspta = $DBobj->listar_ident($date_star,$date_end,$tipo_peo,$anio_peoget,$ident);
        $spreadsheet->getActiveSheet()->setCellValue('B3', "DATOS1 : ". $tipo_peo);
        $spreadsheet->getActiveSheet()->setCellValue('E3', "DATOS2 : ". $tipo_peo);
...
$spreadsheet->getActiveSheet()->duplicateStyle($sharedStyle1, 'F5:H5');
...
$spreadsheet->setActiveSheetIndex(0)
    ...
    ->setCellValue('D6', 'DATOS1')
    ->setCellValue('E6', 'DATOS2')
