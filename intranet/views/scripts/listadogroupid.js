...
autocomplet();
    ...
    $.post("./../controllers/listadogroupid.php?op=listgroupcard",function(r){
        $("#group_list").html(r);
    });
...
function listgroupstudent(detalle_group){
    ...
    if (detalle_group=="Estudiante") {
                ...
                $.post("./../controllers/listadogroupid.php?op=listgroupstudent&anio_peoget="+anio_peoget,function(r){
        ...
        t = $('#kt_table_1').DataTable({
            ...
            "ajax": {
                url: './../controllers/listadogroupid.php?op=listar',
                data: { date_star:date_star,date_end:date_end,tipo_peo:detalle_group,datos1_peo:datos1_peo,datos2_peo:datos2_peo,timein:timein,anio_peoget:anio_peoget,identificacion:identificacion},
                type: "get",
                dataType: "json",
                error: function(e) {
   ...
   $("#txttipo_peo").val(tipo_peo);
    ...
    $("#lbltitle").html("Asistencia Estudiantes"+" | "+ datos1_peo + " - " +datos2_peo); 
        ...
        t = $('#kt_table_1').DataTable({
            ...
            "ajax": {
                url: './../controllers/listadogroupid.php?op=listar',
                data: { date_star:date_star,date_end:date_end,tipo_peo:tipo_peo,datos1_peo:datos1_peo,datos2_peo:datos2_peo,timein:timein,anio_peoget:anio_peoget,identificacion:identificacion},
                type: "get",
                dataType: "json",
                error: function(e) {
                    console.log(e.responseText);
...
function autocomplet(){
    ...
    $("#txtid").autocomplete({
        source: function (request, response) {
            ...
            $.ajax({
                url: "./../controllers/listadogroupid.php?op=autocomplete",
...
function reportExceltime() {
    ...
    var identificacion = $("#identificacion").val();
    var timein = $("#timein").val();
    VentanaCentrada('./../reports/listadogroup/rpt_listexcelid.php?date_star='+date_star+'&date_end='+date_end+'&tipo_peo='+tipo_peo+'&datos1_peo='+datos1_peo+'&datos2_peo='+datos2_peo+'&timein='+timein+'&anio_peoget='+anio_peoget+'&identificacion='+identificacion,'Reporte','','1024','768','true');  
}
...
function reportPdftime() {
    ...
    var identificacion = $("#identificacion").val();
    var timein = $("#timein").val();
    VentanaCentrada('./../reports/listadogroup/rpt_listpdfid.php?date_star='+date_star+'&date_end='+date_end+'&tipo_peo='+tipo_peo+'&datos1_peo='+datos1_peo+'&datos2_peo='+datos2_peo+'&timein='+timein+'&anio_peoget='+anio_peoget+'&identificacion='+identificacion,'Reporte','','1024','768','true');  
}
...
function reportWordtime() {
    ...
    var identificacion = $("#identificacion").val();
    var timein = $("#timein").val();
    VentanaCentrada('./../reports/listadogroup/rpt_listwordid.php?date_star='+date_star+'&date_end='+date_end+'&tipo_peo='+tipo_peo+'&datos1_peo='+datos1_peo+'&datos2_peo='+datos2_peo+'&timein='+timein+'&anio_peoget='+anio_peoget+'&identificacion='+identificacion,'Reporte','','1024','768','true');  
}
...
function reportPrinttime() {
    ...
    if (date_star==0 || date_end==0) {
        ...
        $('#divprint').load('./../reports/listadogroup/rpt_listprintid.php?date_star='+date_star+'&date_end='+date_end+'&tipo_peo='+tipo_peo+'&datos1_peo='+datos1_peo+'&datos2_peo='+datos2_peo+'&timein='+timein+'&anio_peoget='+anio_peoget+'&identificacion='+identificacion,function(){
