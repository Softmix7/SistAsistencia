      ...
      <div class="modal-content">
       ...
       <form name="formulario" id="formulario" method="POST">
        <div class="modal-body text-sm">
              ...
              <label>Año:</label><input type="hidden" id="idperiod" name="idperiod" />
              <div class="input-group date" id="periodo" data-target-input="nearest">
              
              <input type="text" id="name_per" name="name_per" class="form-control datetimepicker-input" data-target="#periodo" />
...
<script type="text/javascript" src="scripts/period.js"></script>
